...
export OUTPUT_DIR="./output/generated/lora/${MODEL_NAME}/${DATASET_NAME}"
export LORA_SAVED_DIR="./output/finetune/lora/${MODEL_NAME}/${DATASET_NAME}/checkpoint-15000"
